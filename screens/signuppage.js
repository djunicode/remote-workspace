  ...
  return (
    <View style={styles.container}>
      <View style={styles.box}>
        ...
        <TextInput style={styles.textinput} value={confirm} onChangeText={(value)=>setConfirm(value)}/>
        ...
        <Text style={[styles.textthin,{color:'#3C1361'}]}>
               ...
               <Text style={styles.textthin} onPress={() => navigation.replace("LoginPage")}>Login</Text>
             </Text>
